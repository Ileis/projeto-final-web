(self["webpackChunkbu_backend_v_2"] = self["webpackChunkbu_backend_v_2"] || []).push([[994],{
...
// EXTERNAL MODULE: ./node_modules/@strapi/design-system/Status.js
var Status = __webpack_require__(6495);
...
var Relation_defProp = Object.defineProperty;
var Relation_getOwnPropSymbols = Object.getOwnPropertySymbols;
var Relation_hasOwnProp = Object.prototype.hasOwnProperty;
var Relation_propIsEnum = Object.prototype.propertyIsEnumerable;
var Relation_defNormalProp = (obj, key, value) => key in obj ? Relation_defProp(obj, key, { enumerable: true, configurable: true, writable: true, value }) : obj[key] = value;
var Relation_spreadValues = (a, b) => {
  for (var prop in b || (b = {}))
    if (Relation_hasOwnProp.call(b, prop))
      Relation_defNormalProp(a, prop, b[prop]);
  if (Relation_getOwnPropSymbols)
    for (var prop of Relation_getOwnPropSymbols(b)) {
      if (Relation_propIsEnum.call(b, prop))
        Relation_defNormalProp(a, prop, b[prop]);
    }
  return a;
};
var Relation_objRest = (source, exclude) => {
  var target = {};
  for (var prop in source)
    if (Relation_hasOwnProp.call(source, prop) && exclude.indexOf(prop) < 0)
      target[prop] = source[prop];
  if (source != null && Relation_getOwnPropSymbols)
    for (var prop of Relation_getOwnPropSymbols(source)) {
      if (exclude.indexOf(prop) < 0 && Relation_propIsEnum.call(source, prop))
        target[prop] = source[prop];
    }
  return target;
};
...
const Relation = (_a) => {
  ...
  return /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(Flex.Flex, {
    ...
    alignItems: "end",
    wrap: "wrap"
  }, /* @__PURE__ */ react.createElement(Stack.Stack, Relation_spreadValues({
    basis: size <= 6 ? "100%" : "70%",
    spacing: 1
  }, props), search), loadMore), children);
};
...
var RelationItem_defProp = Object.defineProperty;
var RelationItem_getOwnPropSymbols = Object.getOwnPropertySymbols;
var RelationItem_hasOwnProp = Object.prototype.hasOwnProperty;
var RelationItem_propIsEnum = Object.prototype.propertyIsEnumerable;
var RelationItem_defNormalProp = (obj, key, value) => key in obj ? RelationItem_defProp(obj, key, { enumerable: true, configurable: true, writable: true, value }) : obj[key] = value;
var RelationItem_spreadValues = (a, b) => {
  for (var prop in b || (b = {}))
    if (RelationItem_hasOwnProp.call(b, prop))
      RelationItem_defNormalProp(a, prop, b[prop]);
  if (RelationItem_getOwnPropSymbols)
    for (var prop of RelationItem_getOwnPropSymbols(b)) {
      if (RelationItem_propIsEnum.call(b, prop))
        RelationItem_defNormalProp(a, prop, b[prop]);
    }
  return a;
};
var RelationItem_objRest = (source, exclude) => {
  var target = {};
  for (var prop in source)
    if (RelationItem_hasOwnProp.call(source, prop) && exclude.indexOf(prop) < 0)
      target[prop] = source[prop];
  if (source != null && RelationItem_getOwnPropSymbols)
    for (var prop of RelationItem_getOwnPropSymbols(source)) {
      if (exclude.indexOf(prop) < 0 && RelationItem_propIsEnum.call(source, prop))
        target[prop] = source[prop];
    }
  return target;
};
...
const ChildrenWrapper = (0,styled_components_browser_cjs["default"])(Flex.Flex)`
  width: 100%;
  /* Used to prevent endAction to be pushed out of container */
  min-width: 0;
`;
const RelationItem = (_a) => {
  var _b = _a, { children, disabled, endAction, style } = _b, props = RelationItem_objRest(_b, ["children", "disabled", "endAction", "style"]);
  return /* @__PURE__ */ react.createElement(Box.Box, {
    style,
    as: "li"
  }, /* @__PURE__ */ react.createElement(Flex.Flex, RelationItem_spreadValues({
    paddingTop: 2,
    paddingBottom: 2,
    paddingLeft: 4,
    paddingRight: 4,
    ...
    justifyContent: "space-between"
  }, props), /* @__PURE__ */ react.createElement(ChildrenWrapper, {
    justifyContent: "space-between"
  }, children), endAction && /* @__PURE__ */ react.createElement(Box.Box, {
    paddingLeft: 4
  }, endAction)));
};
...
var RelationList_defProp = Object.defineProperty;
var RelationList_getOwnPropSymbols = Object.getOwnPropertySymbols;
var RelationList_hasOwnProp = Object.prototype.hasOwnProperty;
var RelationList_propIsEnum = Object.prototype.propertyIsEnumerable;
var RelationList_defNormalProp = (obj, key, value) => key in obj ? RelationList_defProp(obj, key, { enumerable: true, configurable: true, writable: true, value }) : obj[key] = value;
var RelationList_spreadValues = (a, b) => {
  for (var prop in b || (b = {}))
    if (RelationList_hasOwnProp.call(b, prop))
      RelationList_defNormalProp(a, prop, b[prop]);
  if (RelationList_getOwnPropSymbols)
    for (var prop of RelationList_getOwnPropSymbols(b)) {
      if (RelationList_propIsEnum.call(b, prop))
        RelationList_defNormalProp(a, prop, b[prop]);
    }
  return a;
};
var RelationList_objRest = (source, exclude) => {
  var target = {};
  for (var prop in source)
    if (RelationList_hasOwnProp.call(source, prop) && exclude.indexOf(prop) < 0)
      target[prop] = source[prop];
  if (source != null && RelationList_getOwnPropSymbols)
    for (var prop of RelationList_getOwnPropSymbols(source)) {
      if (exclude.indexOf(prop) < 0 && RelationList_propIsEnum.call(source, prop))
        target[prop] = source[prop];
    }
  return target;
};
...
const ShadowBox = (0,styled_components_browser_cjs["default"])(Box.Box)`
  position: relative;
  overflow-x: hidden;
  overflow-y: auto;
  ...
  &:before {
    ...
    content: ${({ overflowDirection }) => overflowDirection === "top-bottom" || overflowDirection === "top" ? "''" : void 0};
  ...
  &:after {
    /* TODO: as for DS Table component we would need this to be handled by the DS theme */
    content: ${({ overflowDirection }) => overflowDirection === "top-bottom" || overflowDirection === "bottom" ? "''" : void 0};
    background: linear-gradient(rgba(0, 0, 0, 0) 0%, rgba(33, 33, 52, 0.1) 100%);
    bottom: 0;
  }
`;
const RelationList = (_a) => {
  var _b = _a, { children, overflow } = _b, props = RelationList_objRest(_b, ["children", "overflow"]);
  return /* @__PURE__ */ react.createElement(ShadowBox, RelationList_spreadValues({
...
const Option = (props) => {
  ...
  if (publicationState) {
    ...
    return /* @__PURE__ */ react.createElement(Component, Option_spreadValues({}, props), /* @__PURE__ */ react.createElement(Flex.Flex, null, /* @__PURE__ */ react.createElement(StyledBullet, {
      title,
      isDraft
    }), /* @__PURE__ */ react.createElement(Typography.Typography, {
      ellipsis: true
    }, mainField != null ? mainField : id)));
  }
  return /* @__PURE__ */ react.createElement(Component, Option_spreadValues({}, props), mainField != null ? mainField : id);
};
Option.propTypes = {
...
var RelationInput_defProp = Object.defineProperty;
var RelationInput_defProps = Object.defineProperties;
var RelationInput_getOwnPropDescs = Object.getOwnPropertyDescriptors;
var RelationInput_getOwnPropSymbols = Object.getOwnPropertySymbols;
var RelationInput_hasOwnProp = Object.prototype.hasOwnProperty;
var RelationInput_propIsEnum = Object.prototype.propertyIsEnumerable;
var RelationInput_defNormalProp = (obj, key, value) => key in obj ? RelationInput_defProp(obj, key, { enumerable: true, configurable: true, writable: true, value }) : obj[key] = value;
var RelationInput_spreadValues = (a, b) => {
  for (var prop in b || (b = {}))
    if (RelationInput_hasOwnProp.call(b, prop))
      RelationInput_defNormalProp(a, prop, b[prop]);
  if (RelationInput_getOwnPropSymbols)
    for (var prop of RelationInput_getOwnPropSymbols(b)) {
      if (RelationInput_propIsEnum.call(b, prop))
        RelationInput_defNormalProp(a, prop, b[prop]);
    }
  return a;
};
var RelationInput_spreadProps = (a, b) => RelationInput_defProps(a, RelationInput_getOwnPropDescs(b));
...
const LinkEllipsis = (0,styled_components_browser_cjs["default"])(design_system_Link.Link)`
  white-space: nowrap;
  overflow: hidden;
  text-overflow: ellipsis;
  display: inherit;
`;
const BoxEllipsis = (0,styled_components_browser_cjs["default"])(Box.Box)`
  > span {
    white-space: nowrap;
    overflow: hidden;
    text-overflow: ellipsis;
...
`;
const DisconnectButton = styled_components_browser_cjs["default"].button`
  svg path {
    fill: ${({ theme }) => theme.colors.neutral500};
  }
...
const RelationInput = ({
  ...
  const totalNumberOfRelations = (_a = relations.length) != null ? _a : 0;
  const dynamicListHeight = (0,react.useMemo)(
    () => totalNumberOfRelations > numberOfRelationsToDisplay ? Math.min(totalNumberOfRelations, numberOfRelationsToDisplay) * RELATION_ITEM_HEIGHT + RELATION_ITEM_HEIGHT / 2 : Math.min(totalNumberOfRelations, numberOfRelationsToDisplay) * RELATION_ITEM_HEIGHT,
    [totalNumberOfRelations, numberOfRelationsToDisplay]
  );
  const shouldDisplayLoadMoreButton = !!labelLoadMore && !disabled && paginatedRelations.hasNextPage || paginatedRelations.isLoading;
  const options = (0,react.useMemo)(
    () => data.flat().filter(Boolean).map((result) => RelationInput_spreadProps(RelationInput_spreadValues({}, result), {
      value: result.id,
  ...
  return /* @__PURE__ */ react.createElement(Field.Field, {
    ...
    hint: description,
    id
  }, /* @__PURE__ */ react.createElement(Relation, {
    totalNumberOfRelations,
    size,
    search: /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(Field.FieldLabel, {
      action: labelAction,
      required
    }, label), /* @__PURE__ */ react.createElement(build.ReactSelect, {
    ...
    loadMore: shouldDisplayLoadMoreButton && /* @__PURE__ */ react.createElement(TextButton.TextButton, {
  ...
  }, /* @__PURE__ */ react.createElement(RelationList, {
    overflow
  }, /* @__PURE__ */ react.createElement(index_cjs/* FixedSizeList */.t7, {
    ...
    itemData: relations,
    innerElementType: "ol"
  }, ({ data: data2, index, style }) => {
    const { publicationState, href, mainField, id: id2 } = data2[index];
    const statusColor = publicationState === "draft" ? "secondary" : "success";
    return /* @__PURE__ */ react.createElement(RelationItem, {
      disabled,
      key: `relation-${name}-${id2}`,
      endAction: /* @__PURE__ */ react.createElement(DisconnectButton, {
        "data-testid": `remove-relation-${id2}`,
        disabled,
        type: "button",
        onClick: () => onRelationDisconnect(data2[index]),
      ...
      style
    }, /* @__PURE__ */ react.createElement(BoxEllipsis, {
      minWidth: 0,
      paddingTop: 1,
      paddingBottom: 1,
      paddingRight: 4
    }, /* @__PURE__ */ react.createElement(Tooltip.Tooltip, {
      description: mainField != null ? mainField : `${id2}`
    }, href ? /* @__PURE__ */ react.createElement(LinkEllipsis, {
      to: href,
      disabled
    }, mainField != null ? mainField : id2) : /* @__PURE__ */ react.createElement(Typography.Typography, {
      textColor: disabled ? "neutral600" : "primary600",
      ellipsis: true
    }, mainField != null ? mainField : id2))), publicationState && /* @__PURE__ */ react.createElement(Status.Status, {
      variant: statusColor,
      showBullet: false,
      size: "S"
    }, /* @__PURE__ */ react.createElement(Typography.Typography, {
  ...
  })), (description || error) && /* @__PURE__ */ react.createElement(Box.Box, {
    paddingTop: 2
  }, /* @__PURE__ */ react.createElement(Field.FieldHint, null), /* @__PURE__ */ react.createElement(Field.FieldError, null))));
};
...
/* harmony default export */ const RelationInputDataManager_utils_connect = (connect_connect);
...
function select_useSelect({
  ...
  let componentId;
  if (componentUid) {
    componentId = (_a = get_default()(initialData, fieldNameKeys.slice(0, -1))) == null ? void 0 : _a.id;
  }
  const relationFetchEndpoint = (0,react.useMemo)(() => {
    ...
    return utils_getRequestUrl(`relations/${slug}/${initialData.id}/${name.split(".").at(-1)}`);
  ...
  return {
    ...
    queryInfos: select_spreadProps(select_spreadValues({}, queryInfos), {
      endpoints: {
...
/* harmony default export */ const RelationInputDataManager_utils_select = (select_useSelect);
...
function getRelationLink(targetModel, id) {
  return `${utils_getRequestUrl(`collectionType/${targetModel}/${id != null ? id : ""}`)}`;
}
...
var normalizeRelations_defProp = Object.defineProperty;
var normalizeRelations_getOwnPropSymbols = Object.getOwnPropertySymbols;
var normalizeRelations_hasOwnProp = Object.prototype.hasOwnProperty;
var normalizeRelations_propIsEnum = Object.prototype.propertyIsEnumerable;
var normalizeRelations_defNormalProp = (obj, key, value) => key in obj ? normalizeRelations_defProp(obj, key, { enumerable: true, configurable: true, writable: true, value }) : obj[key] = value;
var normalizeRelations_spreadValues = (a, b) => {
  for (var prop in b || (b = {}))
    if (normalizeRelations_hasOwnProp.call(b, prop))
      normalizeRelations_defNormalProp(a, prop, b[prop]);
  if (normalizeRelations_getOwnPropSymbols)
    for (var prop of normalizeRelations_getOwnPropSymbols(b)) {
      if (normalizeRelations_propIsEnum.call(b, prop))
        normalizeRelations_defNormalProp(a, prop, b[prop]);
    }
  return a;
};
...
const normalizeRelation = (relation, { shouldAddLink, mainFieldName, targetModel }) => {
  const nextRelation = normalizeRelations_spreadValues({}, relation);
  if (shouldAddLink) {
    nextRelation.href = getRelationLink(targetModel, nextRelation.id);
  }
  nextRelation.publicationState = false;
  if ((nextRelation == null ? void 0 : nextRelation.publishedAt) !== void 0) {
...
var normalizeSearchResults_defProp = Object.defineProperty;
var normalizeSearchResults_defProps = Object.defineProperties;
var normalizeSearchResults_getOwnPropDescs = Object.getOwnPropertyDescriptors;
var normalizeSearchResults_getOwnPropSymbols = Object.getOwnPropertySymbols;
var normalizeSearchResults_hasOwnProp = Object.prototype.hasOwnProperty;
var normalizeSearchResults_propIsEnum = Object.prototype.propertyIsEnumerable;
var normalizeSearchResults_defNormalProp = (obj, key, value) => key in obj ? normalizeSearchResults_defProp(obj, key, { enumerable: true, configurable: true, writable: true, value }) : obj[key] = value;
var normalizeSearchResults_spreadValues = (a, b) => {
  for (var prop in b || (b = {}))
    if (normalizeSearchResults_hasOwnProp.call(b, prop))
      normalizeSearchResults_defNormalProp(a, prop, b[prop]);
  if (normalizeSearchResults_getOwnPropSymbols)
    for (var prop of normalizeSearchResults_getOwnPropSymbols(b)) {
      if (normalizeSearchResults_propIsEnum.call(b, prop))
        normalizeSearchResults_defNormalProp(a, prop, b[prop]);
    }
  return a;
};
var normalizeSearchResults_spreadProps = (a, b) => normalizeSearchResults_defProps(a, normalizeSearchResults_getOwnPropDescs(b));

const normalizeSearchResults = (relations, { mainFieldName }) => {
  const { data } = relations;
  const { pages = [] } = data != null ? data : {};
  return normalizeSearchResults_spreadProps(normalizeSearchResults_spreadValues({}, relations), {
    data: pages.map(
      (page) => page == null ? void 0 : page.results.map((relation) => normalizeRelation(relation, { mainFieldName }))
    ).filter(Boolean).flat()
  });
};
...
var useRelation_defProp = Object.defineProperty;
var useRelation_defProps = Object.defineProperties;
var useRelation_getOwnPropDescs = Object.getOwnPropertyDescriptors;
var useRelation_getOwnPropSymbols = Object.getOwnPropertySymbols;
var useRelation_hasOwnProp = Object.prototype.hasOwnProperty;
var useRelation_propIsEnum = Object.prototype.propertyIsEnumerable;
var useRelation_defNormalProp = (obj, key, value) => key in obj ? useRelation_defProp(obj, key, { enumerable: true, configurable: true, writable: true, value }) : obj[key] = value;
var useRelation_spreadValues = (a, b) => {
  for (var prop in b || (b = {}))
    if (useRelation_hasOwnProp.call(b, prop))
      useRelation_defNormalProp(a, prop, b[prop]);
  if (useRelation_getOwnPropSymbols)
    for (var prop of useRelation_getOwnPropSymbols(b)) {
      if (useRelation_propIsEnum.call(b, prop))
        useRelation_defNormalProp(a, prop, b[prop]);
    }
  return a;
};
var useRelation_spreadProps = (a, b) => useRelation_defProps(a, useRelation_getOwnPropDescs(b));
var useRelation_async = (__this, __arguments, generator) => {
  return new Promise((resolve, reject) => {
    var fulfilled = (value) => {
      try {
        step(generator.next(value));
...
const useRelation = (cacheKey, { name, relation, search }) => {
  const [searchParams, setSearchParams] = (0,react.useState)({});
  const [currentPage, setCurrentPage] = (0,react.useState)(0);
  const fetchRelations = (_0) => useRelation_async(void 0, [_0], function* ({ pageParam = 1 }) {
    var _a;
    try {
      const { data: data2 } = yield utils/* axiosInstance.get */.be.get(relation == null ? void 0 : relation.endpoint, {
        params: useRelation_spreadProps(useRelation_spreadValues({}, (_a = relation.pageParams) != null ? _a : {}), {
          page: pageParam
        })
      });
  ...
  const fetchSearch = (_0) => useRelation_async(void 0, [_0], function* ({ pageParam = 1 }) {
    var _a;
    try {
      const { data: data2 } = yield utils/* axiosInstance.get */.be.get(search.endpoint, {
        params: useRelation_spreadProps(useRelation_spreadValues(useRelation_spreadValues({}, (_a = search.pageParams) != null ? _a : {}), searchParams), {
          page: pageParam
        })
      });
      return data2;
  ...
  const relationsRes = (0,react_query_lib.useInfiniteQuery)(["relation", cacheKey], fetchRelations, {
    ...
    getNextPageParam(lastPage) {
      const isXToOneRelation = !(lastPage == null ? void 0 : lastPage.pagination);
      if (!lastPage || isXToOneRelation || (lastPage == null ? void 0 : lastPage.pagination.page) >= (lastPage == null ? void 0 : lastPage.pagination.pageCount)) {
        return void 0;
      }
      return lastPage.pagination.page + 1;
    },
    select: (data2) => useRelation_spreadProps(useRelation_spreadValues({}, data2), {
  ...
  (0,react.useEffect)(() => {
    var _a, _b;
    if (status === "success" && data && ((_b = (_a = data.pages) == null ? void 0 : _a.at(-1)) == null ? void 0 : _b.results) && onLoadRelationsCallback) {
  ...
  const searchRes = (0,react_query_lib.useInfiniteQuery)(
    ...
    fetchSearch,
    {
      ...
      getNextPageParam(lastPage) {
        if (!(lastPage == null ? void 0 : lastPage.pagination) || lastPage.pagination.page >= lastPage.pagination.pageCount) {
          return void 0;
        }
        return lastPage.pagination.page + 1;
      }
  ...
  const searchFor = (term, options = {}) => {
    setSearchParams(useRelation_spreadProps(useRelation_spreadValues({}, options), {
      _q: term
    }));
  };
...
var RelationInputDataManager_defProp = Object.defineProperty;
var RelationInputDataManager_defProps = Object.defineProperties;
var RelationInputDataManager_getOwnPropDescs = Object.getOwnPropertyDescriptors;
var RelationInputDataManager_getOwnPropSymbols = Object.getOwnPropertySymbols;
var RelationInputDataManager_hasOwnProp = Object.prototype.hasOwnProperty;
var RelationInputDataManager_propIsEnum = Object.prototype.propertyIsEnumerable;
var RelationInputDataManager_defNormalProp = (obj, key, value) => key in obj ? RelationInputDataManager_defProp(obj, key, { enumerable: true, configurable: true, writable: true, value }) : obj[key] = value;
var RelationInputDataManager_spreadValues = (a, b) => {
  for (var prop in b || (b = {}))
    if (RelationInputDataManager_hasOwnProp.call(b, prop))
      RelationInputDataManager_defNormalProp(a, prop, b[prop]);
  if (RelationInputDataManager_getOwnPropSymbols)
    for (var prop of RelationInputDataManager_getOwnPropSymbols(b)) {
      if (RelationInputDataManager_propIsEnum.call(b, prop))
        RelationInputDataManager_defNormalProp(a, prop, b[prop]);
    }
  return a;
};
var RelationInputDataManager_spreadProps = (a, b) => RelationInputDataManager_defProps(a, RelationInputDataManager_getOwnPropDescs(b));
...
const RelationInputDataManager = ({
  ...
  const { formatMessage } = (0,react_intl.useIntl)();
  const { connectRelation, disconnectRelation, loadRelation, modifiedData, slug, initialData } = (0,build.useCMEditViewDataManager)();
  const relationsFromModifiedData = (_a = get_default()(modifiedData, name)) != null ? _a : [];
  const currentLastPage = Math.ceil(get_default()(initialData, name, []).length / RELATIONS_TO_DISPLAY);
  const { relations, search, searchFor } = useRelation(`${slug}-${name}-${(_b = initialData == null ? void 0 : initialData.id) != null ? _b : ""}`, {
    name,
    relation: {
      enabled: !!endpoints.relation,
      endpoint: endpoints.relation,
      pageGoal: currentLastPage,
      pageParams: RelationInputDataManager_spreadProps(RelationInputDataManager_spreadValues({}, defaultParams), {
  ...
  const serverRelationsCount = ((_c = get_default()(initialData, name)) != null ? _c : []).length;
  const realServerRelationsCount = (_g = (_f = (_e = (_d = relations.data) == null ? void 0 : _d.pages[0]) == null ? void 0 : _e.pagination) == null ? void 0 : _f.total) != null ? _g : 0;
  ...
  return /* @__PURE__ */ react.createElement(RelationInput_RelationInput, {
    error,
    description,
    disabled: isDisabled,
    id: name,
    ...
    relations: pick_default()(
      RelationInputDataManager_spreadProps(RelationInputDataManager_spreadValues({}, relations), { data: relationsFromModifiedData }),
      "data",
      "hasNextPage",
      "isFetchingNextPage",
      "isLoading",
...
function Inputs({
  ...
  if (type === "relation") {
    return /* @__PURE__ */ react.createElement(RelationInputDataManager_RelationInputDataManager, Inputs_spreadProps(Inputs_spreadValues(Inputs_spreadValues({}, metadatas), fieldSchema), {
      componentUid,
...
/* harmony default export */ const FieldComponent_Label = (Label_Label);
...
`;
const DynamicComponent_StyledBox = (0,styled_components_browser_cjs["default"])(Box.Box)`
  > div:first-child {
...
`;
const Rectangle = (0,styled_components_browser_cjs["default"])(Box.Box)`
...
const DynamicZoneComponent = ({
  ...
  const { formatMessage } = (0,react_intl.useIntl)();
  const { getComponentLayout } = hooks_useContentTypeLayout();
  const { modifiedData } = (0,build.useCMEditViewDataManager)();
  const { icon, friendlyName, mainValue } = (0,react.useMemo)(() => {
    ...
    const mainField = (_a = get_default()(modifiedData, [name, index, mainFieldKey])) != null ? _a : "";
  ...
  return /* @__PURE__ */ react.createElement(Box.Box, null, /* @__PURE__ */ react.createElement(Flex.Flex, {
    ...
    background: "neutral200"
  })), /* @__PURE__ */ react.createElement(DynamicComponent_StyledBox, {
    hasRadius: true
...
DynamicZoneComponent.propTypes = {
  ...
  isFieldAllowed: (prop_types_default()).bool,
  name: (prop_types_default()).string.isRequired,
  onMoveComponentDownClick: (prop_types_default()).func.isRequired,
  onMoveComponentUpClick: (prop_types_default()).func.isRequired,
  onRemoveComponentClick: (prop_types_default()).func.isRequired,
  showDownIcon: (prop_types_default()).bool,
  showUpIcon: (prop_types_default()).bool
};
...
const DynamicZoneLabel_StyledBox = (0,styled_components_browser_cjs["default"])(Box.Box)`
...
const DynamicZoneLabel = ({
  ...
  return /* @__PURE__ */ react.createElement(Flex.Flex, {
    justifyContent: "center"
  }, /* @__PURE__ */ react.createElement(Box.Box, null, /* @__PURE__ */ react.createElement(DynamicZoneLabel_StyledBox, {
    paddingTop: 3,
    paddingBottom: 3,
    paddingRight: 4,
    paddingLeft: 4,
...
`;
function ComponentCard({ children, icon, onClick }) {
...
const ComponentCategory_Grid = styled_components_browser_cjs["default"].div`
  display: grid;
...
const ComponentCategory = ({ category, components, variant, isOpen, onAddComponent, onToggle }) => {
  ...
  return /* @__PURE__ */ react.createElement(Accordion.Accordion, {
    ...
    paddingLeft: 3,
    paddingRight: 3
  }, /* @__PURE__ */ react.createElement(ComponentCategory_Grid, null, components.map(({ componentUid, info: { displayName, icon } }) => /* @__PURE__ */ react.createElement(ComponentCard, {
    key: componentUid,
    icon,
...
const ComponentPicker = ({ components, isOpen, onClickAddComponent }) => {
  ...
  return /* @__PURE__ */ react.createElement(Box.Box, {
    ...
    attributeName: "data-strapi-accordion-toggle"
  }, dynamicComponentCategories.map(({ category, components: components2 }, index) => /* @__PURE__ */ react.createElement(components_ComponentCategory, {
    key: category,
    category,
...
const DynamicZone = ({
  ...
  const handleMoveComponentDown = (name2, componentIndex) => () => {
    moveComponentDown(name2, componentIndex);
  };
  const handleMoveComponentUp = (name2, componentIndex) => () => {
    moveComponentUp(name2, componentIndex);
  };
  ...
  return /* @__PURE__ */ react.createElement(Stack.Stack, {
    spacing: 6
  }, dynamicDisplayedComponentsLength > 0 && /* @__PURE__ */ react.createElement(Box.Box, null, /* @__PURE__ */ react.createElement(components_DynamicZoneLabel, {
    intlDescription,
    ...
    isOpen: addComponentIsOpen,
    components: (_a = fieldSchema.components) != null ? _a : [],
...
const CollectionTypeFormWrapper = ({ allLayoutData, children, slug, id, origin }) => {
  ...
  const onDraftRelationCheck = (0,react.useCallback)(() => CollectionTypeFormWrapper_async(void 0, null, function* () {
    try {
      ...
      const numberOfDraftRelations = yield utils/* axiosInstance.get */.be.get(endPoint);
...
const cleanData = ({ browserState, serverState }, currentSchema, componentsSchema) => {
  ...
  const recursiveCleanData = (browserState2, serverState2, schema) => {
        ...
        case "component":
          if (isRepeatable) {
            cleanedData = value ? value.map((data, index) => {
              const subCleanedData = recursiveCleanData(
                data,
                (oldValue != null ? oldValue : [])[index],
                componentsSchema[component]
              );
              return subCleanedData;
            }) : value;
          } else {
            cleanedData = value ? recursiveCleanData(value, oldValue, componentsSchema[component]) : value;
          }
          break;
        case "relation": {
          let actualOldValue = oldValue != null ? oldValue : [];
          const connectedRelations = value.reduce((acc2, relation) => {
...
;// CONCATENATED MODULE: ./.cache/admin/src/content-manager/components/EditViewDataManagerProvider/utils/recursivelyFindPathsBasedOnCondition.js
  ...
  const recursivelyFindPathsBasedOnCondition = (attributes) => {
    return Object.entries(attributes).reduce((acc, [key, value]) => {
      ...
      if (value.type === "component") {
        ...
        const attributesInDynamicComponents = dynamicComponents.flatMap((componentName) => {
...
;// CONCATENATED MODULE: ./.cache/admin/src/content-manager/components/EditViewDataManagerProvider/utils/findLeafByPathAndReplace.js

const findLeafByPathAndReplace = (endpath, replaceWith) => {
  const findLeafAndReplace = (acc, curr, ind, currentArr) => {
    if (!acc)
      return acc;
    if (endpath === curr && acc[curr] !== void 0) {
      set_default()(acc, curr, replaceWith);
      return acc;
    }
...
const reducer_reducer = (state, action) => (0,immer_cjs_production_min["default"])(state, (draftState) => {
  switch (action.type) {
    case "ADD_NON_REPEATABLE_COMPONENT_TO_FIELD": {
      ...
      const relationPaths = recursivelyFindPathsBasedOnConditionSetup(
        allComponents,
        (value) => value.type === "relation"
      )(componentLayoutData.attributes);
      const defaultDataStructure = EditViewDataManagerProvider_reducer_spreadValues({}, state.componentsDataStructure[componentLayoutData.uid]);
      const repeatableFields = recursivelyFindPathsBasedOnConditionSetup(
        allComponents,
    ...
    case "ADD_REPEATABLE_COMPONENT_TO_FIELD": {
      ...
      const defaultDataStructure = action.type === "ADD_COMPONENT_TO_DYNAMIC_ZONE" ? EditViewDataManagerProvider_reducer_spreadProps(EditViewDataManagerProvider_reducer_spreadValues({}, state.componentsDataStructure[componentLayoutData.uid]), {
        __component: componentLayoutData.uid
      }) : EditViewDataManagerProvider_reducer_spreadProps(EditViewDataManagerProvider_reducer_spreadValues({}, state.componentsDataStructure[componentLayoutData.uid]), {
    ...
    case "LOAD_RELATION": {
      ...
      set_default()(draftState, initialDataPath, uniqBy_default()([...value, ...initialDataRelations], "id"));
      set_default()(draftState, modifiedDataPath, uniqBy_default()([...value, ...modifiedDataRelations], "id"));
      break;
    }
    ...
    case "INIT_FORM": {
      ...
      const mergeDataWithPreparedRelations = relationalFieldPaths.map((path) => path.split(".")).reduce((acc, currentPaths) => {
        const [componentName] = currentPaths;
        if (state.modifiedData && get_default()(state.modifiedData, componentName)) {
          const currentState = cloneDeep_default()(get_default()(state.modifiedData, componentName));
          set_default()(acc, componentName, merge_default()(currentState, get_default()(initialValues, componentName)));
        } else if (repeatableComponentPaths.includes(componentName) || dynamicZonePaths.includes(componentName) || componentPaths.includes(componentName)) {
          const findleaf = findLeafByPathAndReplace(currentPaths.slice(-1)[0], []);
          currentPaths.reduce(findleaf, acc);
        } else {
          set_default()(acc, currentPaths, []);
        }
        return acc;
      }, data);
    ...
    case "SET_PUBLISH_CONFIRMATION": {
      draftState.publishConfirmation = EditViewDataManagerProvider_reducer_spreadValues({}, action.publishConfirmation);
      break;
    }
    case "RESET_PUBLISH_CONFIRMATION": {
      draftState.publishConfirmation = EditViewDataManagerProvider_reducer_spreadProps(EditViewDataManagerProvider_reducer_spreadValues({}, state.publishConfirmation), { show: false });
      break;
    }
    default:
      return draftState;
...
const EditViewDataManagerProvider = ({
  ...
  (0,react.useEffect)(() => {
    if (initialValues && (currentContentTypeLayout == null ? void 0 : currentContentTypeLayout.attributes)) {
      const relationalFieldPaths = recursivelyFindPathsBasedOnConditionSetup(
        components,
        (value) => value.type === "relation"
      )(currentContentTypeLayout.attributes);
      const componentPaths = recursivelyFindPathsBasedOnConditionSetup(
        components,
        (value) => value.type === "component" && !value.repeatable
      )(currentContentTypeLayout.attributes);
      const repeatableComponentPaths = recursivelyFindPathsBasedOnConditionSetup(
        components,
        (value) => value.type === "component" && value.repeatable
      )(currentContentTypeLayout.attributes);
      const dynamicZonePaths = recursivelyFindPathsBasedOnConditionSetup(
        components,
  ...
  const connectRelation = (0,react.useCallback)(({ name, value, toOneRelation }) => {
    dispatch({
  ...
  const loadRelation = (0,react.useCallback)(({ target: { name, value } }) => {
    dispatch({
      type: "LOAD_RELATION",
      keys: name.split("."),
      value
  ...
  const createFormData = (0,react.useCallback)(
    (modifiedData2, initialData2) => {
      const preparedData = utils_removeKeyInObject(cloneDeep_default()(modifiedData2), "__temp_key__");
      const cleanedData = utils_cleanData(
        { browserState: preparedData, serverState: initialData2 },
        currentContentTypeLayout,
        allLayoutData.components
      );
      return cleanedData;
  ...
  const handlePublishPromptDismissal = (0,react.useCallback)((e) => EditViewDataManagerProvider_async(void 0, null, function* () {
    e.preventDefault();
    return dispatch({
  ...
  const handlePublish = (0,react.useCallback)(() => EditViewDataManagerProvider_async(void 0, null, function* () {
    ...
    const draftCount = yield onDraftRelationCheck();
  ...
  const disconnectRelation = (0,react.useCallback)(({ name, id }) => {
    dispatch({
  ...
  }, isLoadingForData || !isCreatingEntry && !initialData.id ? /* @__PURE__ */ react.createElement(Main.Main, {
    "aria-busy": "true"
...
const SingleTypeFormWrapper = ({ allLayoutData, children, slug }) => {
  ...
  const onDraftRelationCheck = (0,react.useCallback)(() => SingleTypeFormWrapper_async(void 0, null, function* () {
    try {
      trackUsageRef.current("willCheckDraftRelations");
...
const FlexTextAlign = (0,styled_components_browser_cjs["default"])(Flex.Flex)`
  text-align: center;
`;
const Header = ({
  ...
  return /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(Layout.HeaderLayout, {
  ...
  }), /* @__PURE__ */ react.createElement(Dialog.Dialog, {
    ...
    spacing: 2
  }, /* @__PURE__ */ react.createElement(FlexTextAlign, {
    justifyContent: "center"
  }, /* @__PURE__ */ react.createElement(Typography.Typography, {
    id: "confirm-description"
  }, draftCount, formatMessage(
    {
...
const DisplayedFields = ({ editLayout, fields, onRemoveField, onAddField }) => {
  ...
  }, fields.map((field) => /* @__PURE__ */ react.createElement(SimpleMenu.MenuItem, {
    key: field,
...
var icons_Boolean = __webpack_require__(18561);
var Boolean_default = /*#__PURE__*/__webpack_require__.n(icons_Boolean);
...
var icons_Relation = __webpack_require__(81641);
var Relation_default = /*#__PURE__*/__webpack_require__.n(icons_Relation);
...
var Component = __webpack_require__(29685);
...
const StyledStatus = (0,styled_components_browser_cjs["default"])(Status.Status)`
  width: min-content;
`;
const DynamicTable = ({
  canCreate,
