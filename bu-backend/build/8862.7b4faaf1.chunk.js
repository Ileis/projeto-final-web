...
`])),function(m){return m.hasSideNav?"auto 1fr":"1fr"}),v=u()(p.Box)(i||(i=s()([`
  overflow-x: hidden;
`]))),w=function(m){var y=m.sideNav,x=m.children;return a.a.createElement(O,{hasSideNav:Boolean(y)},y,a.a.createElement(v,{paddingBottom:10},x))};w.defaultProps={sideNav:void 0},w.propTypes={children:h.a.node.isRequired,sideNav:h.a.node};var _,e,t=n(10),g=u()(t.Flex)(_||(_=s()([`
  & > * + * {
    margin-left: `,`;
  }
