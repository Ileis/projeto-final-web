"use strict";
(self["webpackChunkbu_backend_v_2"] = self["webpackChunkbu_backend_v_2"] || []).push([[5895],{
...
const getNewStateFromChangedValues = (options, changedValues) => options.map(([, values]) => values).flat().reduce((acc, curr) => __spreadValues({ [curr.id]: changedValues.includes(curr.id) }, acc), {});
...
var IS_DISABLED=function(){if(window&&window.strapi&&window.strapi.isEE){return (__webpack_require__(53273)/* ["default"] */ .Z);}return (__webpack_require__(79578)/* ["default"] */ .Z);}();var ActionRow=function ActionRow(_ref){var arrayOfOptionsGroupedByCategory=_ref.arrayOfOptionsGroupedByCategory,isFormDisabled=_ref.isFormDisabled,isGrey=_ref.isGrey,label=_ref.label,name=_ref.name,onChange=_ref.onChange,value=_ref.value;var _useIntl=(0,react_intl.useIntl)(),formatMessage=_useIntl.formatMessage;var handleChange=function handleChange(val){onChange(name,getNewStateFromChangedValues(arrayOfOptionsGroupedByCategory,val));};return/*#__PURE__*/react.createElement(Flex.Flex,{as:"li",background:isGrey?'neutral100':'neutral0',paddingBottom:3,paddingTop:3},/*#__PURE__*/react.createElement(Flex.Flex,{paddingLeft:6,style:{width:180}},/*#__PURE__*/react.createElement(Typography.Typography,{variant:"sigma",textColor:"neutral600"},formatMessage({id:'Settings.permissions.conditions.can',defaultMessage:'Can'}),"\xA0"),/*#__PURE__*/react.createElement(Typography.Typography,{variant:"sigma",title:label,textColor:"primary600",ellipsis:true},formatMessage({id:"Settings.roles.form.permissions.".concat(label.toLowerCase()),defaultMessage:label})),/*#__PURE__*/react.createElement(Typography.Typography,{variant:"sigma",textColor:"neutral600"},"\xA0",formatMessage({id:'Settings.permissions.conditions.when',defaultMessage:'When'}))),/*#__PURE__*/react.createElement(Box.Box,{style:{maxWidth:430,width:'100%'}},/*#__PURE__*/react.createElement(Select.MultiSelectNested,{id:name,customizeContent:function customizeContent(values){return"".concat(values.length," currently selected");},onChange:handleChange,value:getSelectedValues(value),options:getNestedOptions(arrayOfOptionsGroupedByCategory),disabled:isFormDisabled||IS_DISABLED})));};ActionRow.propTypes={arrayOfOptionsGroupedByCategory:(prop_types_default()).array.isRequired,isFormDisabled:(prop_types_default()).bool.isRequired,isGrey:(prop_types_default()).bool.isRequired,label:(prop_types_default()).string.isRequired,name:(prop_types_default()).string.isRequired,value:(prop_types_default()).object.isRequired,onChange:(prop_types_default()).func.isRequired};/* harmony default export */ const ConditionsModal_ActionRow = (ActionRow);
...
var ConditionsModal_defProp = Object.defineProperty;
var ConditionsModal_getOwnPropSymbols = Object.getOwnPropertySymbols;
var ConditionsModal_hasOwnProp = Object.prototype.hasOwnProperty;
var ConditionsModal_propIsEnum = Object.prototype.propertyIsEnumerable;
var ConditionsModal_defNormalProp = (obj, key, value) => key in obj ? ConditionsModal_defProp(obj, key, { enumerable: true, configurable: true, writable: true, value }) : obj[key] = value;
var ConditionsModal_spreadValues = (a, b) => {
  for (var prop in b || (b = {}))
    if (ConditionsModal_hasOwnProp.call(b, prop))
      ConditionsModal_defNormalProp(a, prop, b[prop]);
  if (ConditionsModal_getOwnPropSymbols)
    for (var prop of ConditionsModal_getOwnPropSymbols(b)) {
      if (ConditionsModal_propIsEnum.call(b, prop))
        ConditionsModal_defNormalProp(a, prop, b[prop]);
    }
  return a;
};
...
const ConditionsModal = ({ actions, headerBreadCrumbs, isFormDisabled, onClosed, onToggle }) => {
  ...
  const handleSubmit = () => {
    const conditionsWithoutCategory = Object.entries(state).reduce((acc, current) => {
      ...
      const merged = Object.values(value).reduce((acc1, current1) => {
        return ConditionsModal_spreadValues(ConditionsModal_spreadValues({}, acc1), current1);
      }, {});
      acc[key] = merged;
      return acc;
    }, {});
  ...
  ))))), /* @__PURE__ */ react.createElement(ModalLayout.ModalBody, null, actionsToDisplay.length === 0 && /* @__PURE__ */ react.createElement(Typography.Typography, null, formatMessage({
